...
function PaymentModal(props) {
  ...
  // call function in the smart contract to send Pearl token
  // to fund the project
  async function sendFund() {
    ...
    try {
      ...
      await txn.wait()
      alert(`${amount} Pearl Succesfully funded`)
    ...
    <div className="modal">
      ...
      <div className="modalContent">
        <div className="paymentForm">
          <label className="paymentLabel">Amount (Pearl)</label>
          <input
            type="number"
            name="payment"
            id="payment"
            className="payment"
            placeholder="Enter Pearl amount"
            min="1"
            step="1"
            value={amount}
